export const personalInfo = {
  ...
  github: 'https://github.com/gelseyhafalla',
  portfolio: 'https://gelsey-hafalla-profilev2.vercel.app/',
    ...
    roles: [
      {
        ...
        period: '2023 – Current',
        bullets: [
          'Handle team consist of twelve (12) Full Stack web developers.',
          'Monitor the status of system development to ensure on-time completion of projects.',
          'Handle administration-related issues, including addressing programmer concerns that require immediate action.',
      ...
      },
      {
        ...
        period: '2015 – 2023',
        bullets: [
          'Develop web based applications using PHP, Node.js, JavaScript, Vue.js and Laravel framework.',
          'Handle system maintenance and modification requests.',
          'Select programming languages, tools, databases and platforms.',
      ...
      },
      {
        ...
        period: '2012 – 2015',
        bullets: [
          'Manage sending and receiving of confirmations with KSK Japan side for effective communication.',
          'Handle detection of system errors and implement necessary modifications for smooth operation.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Monitor confirmation status, conduct follow-ups and provide continuous feedback.',
        ],
      },
      {
...
export const skills = [
  {
    ...
    icon: 'Code',
    items: [
      'CSS', 'HTML', 'JavaScript', 'jQuery', 'PHP', 'Laravel',
      'Vue.js', 'Vuetify', 'Node.js', 'Express.js',
      'MySQL', 'CouchDB', 'GitLab', 'NPM', 'Yarn', 'REST API', 'API Gateway',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      'MS Teams', 'Photoshop', 'Vectorworks',
    ],
  },
  {
